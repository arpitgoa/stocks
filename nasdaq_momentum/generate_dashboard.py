...
<ul style="margin:5px 0;">
<li>Win rate: <strong>67%</strong> (14/21) | Avg: <strong>+4.3%</strong> | Triggers ~1-2x/yr</li>
...
<ul style="margin:5px 0;">
<li>Win rate: <strong>73%</strong> (11/15) | Avg: <strong>+7.0%</strong> | Triggers ~once/2-3yr</li>
<li>Logic: Epic run confirmed by trend.</li>
</ul>
<p style="margin-top:12px;"><strong>Rule 4: After a -10% Month &rarr; 2x</strong></p>
<ul style="margin:5px 0;">
<li>Win rate: <strong>75%</strong> (12/16) | Avg: <strong>+7.7%</strong> | Triggers ~once/2yr</li>
<li>Logic: Panic washout on momentum stocks &rarr; mean reversion bounce. MaxDD actually improves.</li>
</ul>
<p style="margin-top:12px;"><strong>Combined (all 4 rules):</strong> CAGR 58.0% / MaxDD -32.1% (vs base 42.9% / -26.9%)</p>
