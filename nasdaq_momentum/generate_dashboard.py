...
<h4 style="margin:0 0 10px 0;color:#333;">&#9889; Leverage Rules (Not Automated &mdash; Discretionary)</h4>
<div style="font-size:12px;line-height:1.8;color:#444;">
<p><strong>Rule 1: After Exiting Gold &rarr; 2x that month</strong></p>
<ul style="margin:5px 0;">
<li>Win rate: <strong>100%</strong> (7/7) | Avg return: <strong>+13.8%</strong> | Triggers ~once/4yr</li>
<li>Logic: Re-entry catches momentum built while in gold. Always worked.</li>
</ul>
<p style="margin-top:12px;"><strong>Rule 2: &gt;10% Month + Previous Month Also Green &rarr; 2x</strong></p>
<ul style="margin:5px 0;">
<li>Win rate: <strong>78%</strong> (29/37) | Avg: <strong>+6.3%</strong> | Triggers ~1-2x/yr</li>
<li>Logic: Confirmed momentum run. The "prev green" filter removes dead-cat-bounce false signals.</li>
</ul>
<p style="margin-top:12px;"><strong>Rule 3: Two Consecutive &gt;10% Months + QQQ &gt; 200 DMA &rarr; 2x</strong></p>
<ul style="margin:5px 0;">
<li>Win rate: <strong>92%</strong> (12/13) | Avg: <strong>+13.3%</strong> | Triggers ~once/2-3yr</li>
<li>Logic: Epic run confirmed by trend. Only loss was -3.9%.</li>
</ul>
<p style="margin-top:12px;"><strong>Rule 4: After a -10% Month &rarr; 2x</strong></p>
<ul style="margin:5px 0;">
<li>Win rate: <strong>75%</strong> (12/16) | Avg: <strong>+7.3%</strong> | Triggers ~once/2yr</li>
<li>Logic: Panic washout on momentum stocks &rarr; mean reversion bounce. MaxDD actually improves.</li>
</ul>
<p style="margin-top:12px;"><strong>Combined (all 4 rules):</strong> CAGR 55.8% / MaxDD -32.1% (vs base 40% / -33%)</p>
<p style="margin-top:10px;color:#666;font-style:italic;">NASDAQ-100 only. Requires margin for 2x months (~16% of months). All rules use previous month data only (no look-ahead).</p>
</div>
</div>'''
